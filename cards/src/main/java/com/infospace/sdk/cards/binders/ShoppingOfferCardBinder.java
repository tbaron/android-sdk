...
public class ShoppingOfferCardBinder
	extends StandardCardBinder<ShoppingOfferResult> {
	...
	private void setupPromo() {
		...
		if (view != null) {
			String promo = getModel().isFreeShipping()
				? view.getContext().getString(R.string.insp_card_shopping_free_shipping)
				: null;
